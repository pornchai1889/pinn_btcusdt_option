...
class Settings(BaseSettings):
    ...
    # --- Hardware ---
    DEVICE: str = Field("auto", description="Force specific device (cpu, cuda). 'auto' detects available hardware.")
...
try:
    ...
    logger.critical("Please ensure environment variables are set or a .env file exists.")
