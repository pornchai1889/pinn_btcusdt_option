...
class MarketNormalizer:
    ...
    def _normalize(
        self, val: Union[np.ndarray, torch.Tensor, float], v_range: list[float]
    ...
    def denormalize_batch(
        self, x_norm: Union[np.ndarray, torch.Tensor]
    ...
    def normalize_price(
        self, price: Union[np.ndarray, torch.Tensor], K: Union[np.ndarray, torch.Tensor]
    ...
    def denormalize_price(
        self,
        price_norm: Union[np.ndarray, torch.Tensor],
