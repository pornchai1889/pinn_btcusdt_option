...
class TestMetricsCalculator:
    ...
    def test_smape_logic(self) -> None:
        ...
        np.testing.assert_allclose(smape_2, expected, atol=1e-5, err_msg="SMAPE calculation mismatch")
...
class TestDateUtils:
    ...
    def test_contract_period_calculation(self) -> None:
        ...
        assert end_dt.hour == 8 and end_dt.minute == 0, "Expiration should be at 08:00 UTC (15:00 ICT)"